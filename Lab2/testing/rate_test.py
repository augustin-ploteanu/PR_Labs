...
def spam_test(host="127.0.0.1", port=8081, total=50, delay=0.05):
    ...
    print(f"Elapsed: {elapsed:.2f}s ({total_rps:.1f} total req/s)")
    print(f"200 OK: {count_200}  ({succ_rps:.1f} req/s)")
    print(f"429 Too Many: {count_429}  ({denied_rps:.1f} req/s)")
    return results
...
if __name__ == "__main__":
    ...
    spam_results = spam_test("127.0.0.1", 8081, total=50, delay=0.15)
